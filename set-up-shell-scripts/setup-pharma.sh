...
# PharmaCorp Lab Build Script (Reduced User Count)
# Must be run as root
...
# Create users per department (lower count)
declare -A USERS_PER_DEPT
USERS_PER_DEPT=( ["RND"]=6 ["Clinical"]=6 ["Regulatory"]=4 ["IT"]=4 ["HR"]=3 ["Finance"]=3 ["Sales"]=2 ["Manufacturing"]=2 )
